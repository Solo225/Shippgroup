      ...
      <div class="flex flex-col flex-1 w-full">
        ...
        <main class="h-full overflow-y-auto mb-8">
          <div class="container px-6 mx-auto grid">
            ...
            >
        </h2> @auth {{ auth()->user()->nom }} @endauth Historique
            ...
            <div class="w-full overflow-hidden rounded-lg shadow-xs">
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  @auth
                    ...
                    @foreach ($commandes as $commande)
                      ...
                      <td class="px-4 py-3">
                        <a class="font-semibold" href="/recap"> {{ $commande->nombre_colis }}
                  ...
                  @else
                    <tr>
                        <td colspan="4" style="text-align: center; color:green">Pas de commande encours</td>
                    </tr>
                  @endif
                  @endauth
                  ...
                  @guest
                      <tr>
                        <td colspan="4" style="text-align: center; color:green">Ah ah ah ah, connecte toi pour voir les commandes</td>
                    </tr>
                  @endguest
              ...
              <div
                class="grid px-4 py-3 text-xs  tracking-wide text-gray-500 uppercase border-t dark:border-gray-700 bg-gray-50 sm:grid-cols-9 dark:text-gray-400 dark:bg-gray-800"
              >
